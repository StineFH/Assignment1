...
```{r}
# Exploring data - finding our which variables have the same names 
...
```{r}
#Removing characters in VISIT in LU and token 
LU$VISIT <- str_remove_all(LU$VISIT, "[Vvisit.]")
token$VISIT <- str_remove_all(token$VISIT, "[Vvisit.]")
